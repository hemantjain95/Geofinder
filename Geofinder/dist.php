      ...
      <div id="contact-form">
        <form id="contact-us" method = "GET" action = "dist1.php">
          <div class="column-half">
            <div class="formblock">
            <span> From : </span> <input type="text" name="from" id="contactName" value="" class="txt requiredField" placeholder="<?php echo $name; ?>">
            </div>
            <div class="formblock">
              <span>To :</span> <input type="text" name="to" id="email" value="" class="txt requiredField email" placeholder="<?php echo $name2; ?>">
            </div>
